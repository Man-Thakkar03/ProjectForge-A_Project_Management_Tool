...
const Dashboard = () => {
  ...
  const Card = ({ label, count, bg, icon }) => (
    <div className="w-full h-28 sm:h-32 bg-white/5 backdrop-blur-md border border-white/10 rounded-xl hover:shadow-[0_0_30px_#ff00ff40] transition-all duration-300 p-4 sm:p-5 flex items-center justify-between group hover:scale-105">
  ...
  return (
    <div className="h-full py-2">
      ...
      {/* Chart */}
      <div className="w-full max-w-full overflow-x-auto bg-white/5 border border-white/10 backdrop-blur-md my-10 sm:my-16 p-4 sm:p-6 rounded-2xl hover:shadow-[0_0_20px_#ff00ff30] hover:scale-105 duration-700">
        <h4 className="text-xl font-bold text-fuchsia-300 mb-4 drop-shadow-sm">Chart by Priority</h4>
        <Chart />
      </div>

      {/* Tables */}
      <div className="w-full flex flex-col lg:flex-row gap-6 lg:gap-10 py-8">

        {/* Task Table */}
        <div className="w-full lg:w-2/3 overflow-x-auto">
          <div className="min-w-[320px] bg-white/5 backdrop-blur-md border border-white/10 px-4 pt-4 pb-4 hover:shadow-[0_0_20px_#ff00ff30] rounded-2xl overflow-x-auto">
            <table className="w-full">
              ...
              <tbody>
                {tasks.map((task, id) => (
                  <tr key={id} className="border-b border-gray-700/40 text-sm sm:text-base text-gray-300 hover:bg-white/5 transition-all">
                    <td className="py-2">
                    ...
                    <td className="py-2 capitalize flex gap-1 items-center">
                    ...
                    <td className="py-2 hidden md:block text-sm">
            ...
            <table className="w-full">
              ...
              <tbody>
                {summary.users.map((user, index) => (
                  <tr key={index + user?._id} className="border-b border-gray-700/40 text-sm text-gray-300 hover:bg-white/5 transition-all">
                    <td className="py-2">
